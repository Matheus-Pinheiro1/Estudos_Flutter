          ...
          children: <Widget>[
            Row(
              children: [
                ...
                Container(width: 100, child: TextField(controller: controleB)),
              ],
            ),
            Row(
              children: [
            ...
            ElevatedButton(onPressed: calcularA, child: Text('Calcular')),

            Row(children: [Text('Sua área é:'), Text('$resposta')]),
          ],
        ),
      ),
    );
